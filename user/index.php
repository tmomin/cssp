		...
		$(function(){
	        ...
	        $.ajax({
                ...
                success: function() {
                    ...
                    $('#gameupdate').load('get_game.php?'+dataString)
        ...
        function getTotals() {
            ...
            $.ajax({
				...
				error: function(xhr, status, msg) {
					...
					alert("(GET) Failed to get click counts: " + msg);
			...
			//	lastClicked = obj.val(); // set currently clicked radio button to this one
				...
				$.ajax({
					...
					error: function(xhr, status, msg) {
						...
						alert("(INC) Failed to process click count: " + msg);
			...
			//	lastClicked = obj.val(); // set currently clicked radio button to this one
				...
				$.ajax({
					...
					error: function(xhr, status, msg) {
						...
						alert("(DEC) Failed to process click count: " + msg);
    ...
    <div data-role="popup" id="popupLogin" data-theme="a" class="ui-corner-all">
    	...
    	<form>
			...
			<div style="padding:10px 20px;">
                ...
                <input type="text" name="user" id="un" value="" placeholder="confirm" data-theme="a" />
