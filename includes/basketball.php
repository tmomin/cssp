    ...
    for ($c = 0; $c<$col; $c++)
    {
        echo "<td valign='top'>";
            ...
            for ($r=0; $r<$row; $r++)
            {
                ...
                echo "<tr><th class=\"bg\">Team</th><th class=\"bg\">Half 1</th><th class=\"bg\">Half 2</th><th class=\"bg\">OT</th><th class=\"bg\">Final</th></tr>";
                echo "<tr><th class=\"bg\">" . $data[$a]->{'matchup'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'homeq1'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'homeq2'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'homeot'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'homef'} . "</td></tr>";
                echo "<tr><th class=\"bg\">" . $data[$a]->{'matchup'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'awayq1'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'awayq2'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'awayot'} . "</td><td class=\"sam\" align=\"center\">" . $data[$a]->{'awayf'} . "</td></tr>";
                echo "</table>";
                $a++;
            }
            }
