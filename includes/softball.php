...
<?php
    ...
    $sql = "SELECT * FROM softball_scores";
    ...
    $sql2 = "SELECT * FROM softball_matchups";
	...
	if ($detect->isMobile()) {
		for ($r=0; $r<$count; $r++) {
                ...
                echo "<tr><th width=\"40%\" align=\"left\">Final</th><th width=\"auto\">&nbsp;</th><th width=\"15%\" class=\"thscores\">1</th><th width=\"15%\" class=\"thscores\">2</th><th width=\"15%\" class=\"thscores\">OT</th><th width=\"auto\" class=\"thscores\">&nbsp;</th><th width=\"auto\" class=\"thscores\">&nbsp;</th><th width=\"15%\" class=\"thscores\">T</th></tr>";
                echo "<tr class=\"scores\"><td><b>" . $data2[$a]->{'home'} . "</b></td><td>&nbsp;</td><td align=\"center\">" . $data[$a]->{'homeq1'} . "</td><td align=\"center\">" . $data[$a]->{'homeq2'} . "</td><td align=\"center\">" . $data[$a]->{'homeot'} . "</td><td>&nbsp;</td><td>&nbsp;</td><td align=\"center\">" . $data[$a]->{'homef'} . "</td></tr>";
                echo "<tr class=\"scores\"><td><b>" . $data2[$a]->{'away'} . "</b></td><td>&nbsp;</td><td align=\"center\">" . $data[$a]->{'awayq1'} . "</td><td align=\"center\">" . $data[$a]->{'awayq2'} . "</td><td align=\"center\">" . $data[$a]->{'awayot'} . "</td><td>&nbsp;</td><td>&nbsp;</td><td align=\"center\">" . $data[$a]->{'awayf'} . "</td></tr>";
